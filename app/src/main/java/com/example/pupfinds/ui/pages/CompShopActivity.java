...
public class CompShopActivity extends Activity {


    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_compshop);
        WebView pageView = (WebView) findViewById(R.id.compshopweb);
        ...
        pageView.loadUrl("file:///android_asset/WebPages/Cafe/Cafe.html");
